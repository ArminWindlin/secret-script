...
let islands = [30675, 34671, 33271, 40024, 23863, 21223, 19492, 18063, 19292, 16338,
    33924, 24300, 20596, 22821, 23886, 36114, 35021, 34931, 37057, 32698,
    31434, 20764, 25566, 30528, 21637, 35467, 29490, 28589, 24148, 22357,
    25296, 27144, 31551, 35871, 30675];
// CONFIG CULTURE
...
// barracks, docks
let rec = [true, true, true, false, false,
    false, true, true, false, false,
    false, false, false, true, true, //11-15
    true, false, true, true, true,
    false, false, true, false, true, //21-25
...
let building = ['', 'market', 'stoner', 'ironer', '',
    'docks', 'stoner', 'market', 'ironer', 'docks',
    'ironer', 'docks', 'market', 'barracks', 'docks', //11-15
    'market', '', 'temple', 'storage', 'storage',
    'ironer', 'temple', 'docks', 'temple', 'academy', //21-25
    'academy', 'main', 'storage', 'docks', 'docks',
    'academy', 'storage', 'storage', 'storage'];
